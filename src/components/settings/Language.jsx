      ...
      <div>
        ...
        <div class="relative">
          <select
            ...
            class="w-full appearance-none rounded-lg border border-stroke bg-gray-900 px-12 py-3 text-dark outline-hidden focus:border-primary dark:border-dark-3 dark:text-white"
            onChange={langChangeHandler}
          >
            <option value="en">{t("language.en")}</option>
            <option value="fa">{t("language.fa")}</option>
          </select>
          <span class="pointer-events-none absolute left-0 top-0 flex h-full w-12 items-center justify-center text-dark-5">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
