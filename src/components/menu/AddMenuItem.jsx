  ...
  return (
    <form method="post" onSubmit={SubmitHandler}>
      <div className="flex flex-wrap">
        <div className="p-5">
          <label htmlFor="name" className="mb-2.5 block text-base font-medium text-dark dark:text-white">
            {nam}
          </label>
          <input
            ref={nameInput}
        ...
        <div className="p-5">
          <label htmlFor="description" className="mb-2.5 block text-base font-medium text-dark dark:text-white">
            {des}
          </label>
          <input
        ...
        <div className="p-5">
          <label htmlFor="Price" className="mb-2.5 block text-base font-medium text-dark dark:text-white">
            {pr}
          </label>
          <input
            ref={PriceInput}
        ...
        <div className="p-5">
          <label htmlFor="category" className="mb-2.5 block text-base font-medium text-dark dark:text-white">
            {cat}
          </label>
          <select
            ref={categoryInput}
      ...
      {message && (
        <div className={`px-5 py-2 rounded-lg ${message.includes("successfully") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}>
          {message}
        </div>
      )}
      <button
