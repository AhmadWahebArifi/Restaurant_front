    ...
    const SubmitHandler = async (e) => {
        ...
        try {
            ...
            if (response.status === 201 || response.status === 200) {
                ...
                setError(`Failed to ${isEditing ? 'update' : 'add'} table. Please try again.`);
            }
        } catch (error) {
            setError(`Failed to ${isEditing ? 'update' : 'add'} table. Please try again.`);
        } finally {
            ...
            <div className="flex flex-wrap">
                ...
                <div className="p-5">
                    ...
                    >
                        ...
                        <option value="true" className="text-black bg-white">Active</option>
                        <option value="false" className="text-black bg-white">Inactive</option>
                    </select>
                </div>
            </div>
